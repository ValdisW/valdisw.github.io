const blockVertexData = [                                           // 各方块测量数据
    ...
    {id: '8', name: '臭氧发生器', font: '12px Microsoft YaHei', vertex1: [1520, 54], vertex2: [1620, 149]},
    {id: '9', name: '污泥浓缩池', font: '12px Microsoft YaHei', vertex1: [1390, -100], vertex2: [1513, -10]},
    {id: '10', name: '脱水机房加\n药除臭系统', font: '13px Microsoft YaHei', vertex1: [1600, -180], vertex2: [1750, -80]},
    {id: '11', name: '变电站', font: '14px Microsoft YaHei', vertex1: [1650, 52], vertex2: [1750, 182]},
    {id: '12', name: '液氧站', font: '12px Microsoft YaHei', vertex1: [1390, -180], vertex2: [1440, -119]},
